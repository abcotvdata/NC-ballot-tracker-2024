...
voters <- read.csv("./registered_voters_nc.csv")
...
Across North Carolina, <b>`r total_pct_voted_early`%</b> of registered voters cast their ballots in the 2024 Presidential Election.  Early voting ends Saturday, November 2. At that point, voters must wait until Tuesday, November 5 to cast their ballot at their designated precinct.

<div class="container-fluid" style="background-color:##0649C4">
<h3><a href="https://abc11.com/feature/post/voter-guide-2024-north-carolina/15465861/" target="_blank">Click here for ABC11's  Voter Guide</a></h3>
</div>
